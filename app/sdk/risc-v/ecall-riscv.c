...
#define ECALL7(_name, _id, _ret_type, _type0, _arg0, _type1, _arg1, _type2, _arg2, _type3, _arg3, _type4, _arg4, _type5, _arg5, _type6, _arg6) \
    _ret_type _name(_type0 _arg0, _type1 _arg1, _type2 _arg2, _type3 _arg3, _type4 _arg4, _type5 _arg5, _type6 _arg6) \
    {                                                                   \
        register uint32_t a0 asm ("a0") = (uint32_t)_arg0;              \
        register uint32_t a1 asm ("a1") = (uint32_t)_arg1;              \
        register uint32_t a2 asm ("a2") = (uint32_t)_arg2;              \
        ...
        asm (                                                           \
             "li t0, %1\n"                                              \
             "ecall\n"                                                  \
             : "=r"(ret) : "i"(_id), "r"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4), "r"(a5), "r"(a6) : "t0", "memory" \
        );                                                              \
        return ret;                                                     \
    }
...
ECALL2v(ecall_get_random_bytes, ECALL_GET_RANDOM_BYTES, uint8_t *, buffer, const size_t, size)
